...
<Canvas>
  <Story name="underline">
    {{
      ...
      template: `
      <div style="max-width: 400px;">
        <ReInput modifier="underline" placeholder="Password here" />
      </div>
    `,
    }}
  </Story>
    ...
    {{
      ...
      <div style="max-width: 400px;">
        <ReInput class="mb-3" placeholder="With preicon">
          <template #preicon><ReIcon name="search" /></template>
        </ReInput>
        <ReInput class="mb-3" placeholder="With posticon">
          <template #posticon><ReIcon name="search" /></template>
        </ReInput>
      </div>
    `,
    }}
