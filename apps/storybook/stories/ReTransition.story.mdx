...
<Canvas>
  <Story name="fade" height="170px">
    {{
      ...
      template: `
      <div>
        <ReButton size="small" @click="toggle('fade')">fade</ReButton>
        <ReButton size="small" @click="toggle('height')">height</ReButton>
        <ReButton size="small" @click="toggle('slide-right')">slide-right</ReButton>
        <ReButton size="small" @click="toggle('slide-bottom')">slide-bottom</ReButton>
